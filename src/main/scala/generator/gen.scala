...
object Generator extends App {
  ...
  def generateOrder(customer : Customer, product : Product) : Order = {
    ...
    newOrder.qty_=(Random.nextInt(9));
    newOrder.ecommerce_website_name_=(modset_ecommerce_websites.getModLinear(generatorAlpha()).useName());
  ...
  def initializeGenerator() : Unit = {
    ...
    modset_ecommerce_websites("webstore.com").setProbabilityTrendInfo(0.33f, 0.5f);
    modset_ecommerce_websites("onlineretail.com").setProbabilityTrendInfo(0.33f, 0.3f);
    modset_ecommerce_websites("internetshop.com").setProbabilityTrendInfo(0.33f, 0.2f);
